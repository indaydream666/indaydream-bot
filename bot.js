...
var botConfigs = {
    token: "NzI1OTAwMTExNDg5Nzk0MTAw.XwQ5Yw.cTF9SbZHu4bl9yVtGG6GJhV0oHk",
    prefix: ".",
    gameStatus: "",
    ...
    welcomemessage: {
    "channelid": "726399699619282975",
    "text": "Welcome To https;//indaydream.com"
},
    weather: {
    "degree": "C"
},
    autorole: {
    "guildID": "726660700172451851",
    "autoroleID": "726397687536287755"
},
    ticketsystem: {
    "ticketCategoryID": "",
...
client.on("message", async function (message) {
    ...
    if (command === "play" && botConfigs.plugins[8].activated == true) {
        if (!message.member.voiceChannel) return message.channel.send('ERROR TOLOL.');
